...
const VideoCard = ({id,title,thumbnail,userImg,username,views,visibility,duration,createdAt}:VideoCardProps) => {
  return (
   <Link href={`/video/${id}`} className='video-card'>
    ...
    <article>
      <div>
        ...
        <aside> <Image src="/assets/icons/eye.svg" alt="views" width={16} height={16}/>
        <span>{views}</span></aside>
